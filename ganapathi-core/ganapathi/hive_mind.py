...
def run_hive_mind(console, project_dir: str, port: int = HIVE_PORT, host: str = "127.0.0.1"):
    ...
    async def _run():
        ...
        console.print(f"  [bold]Auth Token:[/]   [yellow]{token_data['token'][:16]}...[/]")
        ...
        console.print(f"  Token: [yellow]{token_data['token']}[/]")
        console.print()
        console.print("  [dim]Paste the token in your Ganapathi Web Dashboard → Hive Mind page[/]")
